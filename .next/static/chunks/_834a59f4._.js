...
"[project]/app/[locale]/(admin)/admin/users/data:406a83 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/[locale]/(admin)/admin/users/data:245f4a [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f5b$locale$5d2f28$admin$292f$admin$2f$users$2f$data$3a$245f4a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/[locale]/(admin)/admin/users/data:245f4a [app-client] (ecmascript) <text/javascript>");
...
function CreateUserForm(param) {
    ...
    async function handleSubmit(e) {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f5b$locale$5d2f28$admin$292f$admin$2f$users$2f$data$3a$245f4a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createUser"])(fd);
        setLoading(false);
        if (result.error) {
...
function UsersClient(param) {
    ...
    async function handleDelete(userId, email) {
        ...
        setError(null);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f5b$locale$5d2f28$admin$292f$admin$2f$users$2f$data$3a$406a83__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteUser"])(userId);
        setDeletingId(null);
        if (result.error) {
            setError(result.error);
            return;
...
//# sourceMappingURL=_834a59f4._.js.map