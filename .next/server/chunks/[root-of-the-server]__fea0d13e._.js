module.exports = [
"[project]/.next-internal/server/app/api/agent/cover/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/agent/cover/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    if (!post_id || !query) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "post_id and query are required"
        }, {
            status: 400
        });
    }
    // Unsplash Source API — no key needed, returns a random relevant image
    const slug = query.trim().replace(/\s+/g, ",");
    const imageUrl = `https://source.unsplash.com/featured/1600x900/?${encodeURIComponent(slug)}`;
    // Fetch the image
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fea0d13e._.js.map