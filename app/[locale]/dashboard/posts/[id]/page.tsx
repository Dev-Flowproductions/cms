...
import { getSourcesList, getCitationsForPost } from "@/app/[locale]/(admin)/admin/sources/actions";
import { EditPostForm } from "@/app/[locale]/(admin)/admin/posts/[id]/EditPostForm";
import { updatePost, upsertLocalization, uploadCoverImage } from "@/app/[locale]/(admin)/admin/posts/actions";
...
export default async function DashboardEditPostPage({
  ...
  const postsListHref = "/dashboard/posts";
