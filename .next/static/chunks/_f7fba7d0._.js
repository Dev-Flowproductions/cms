...
function LoginPage() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            window.location.replace("".concat(window.location.origin, "/").concat(localeSegment, "/dashboard"));
        } catch (err) {
            setLoading(false);
...
//# sourceMappingURL=_f7fba7d0._.js.map